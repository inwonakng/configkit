...
outer_from_dict = OuterConfig(outer_name="from_dict", nested_conf={"inner_val": 2}) # mypy should infer InnerConfig
...
# type: ignore
outer_wrong_nested_dict = OuterConfig(outer_name="bad_dict", nested_conf={"inner_val": "wrong_type"})
